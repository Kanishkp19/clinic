...
const cardData = [
  ...
  {
    color: '#120F17',
    title: 'General & Chronic Diseases (सामान्य व पुराने रोग)',
    description: 'Gentle, holistic cures for long-standing systemic diseases like stomach/gastric disorders, paralysis, kidney and gallbladder stones, piles/fissures, arthritis, and sciatica.',
  ...
  {
    color: '#120F17',
    title: 'De-addiction Center (नशा मुक्ति केंद्र)',
    description: 'Effective, confidential homeopathic program for natural detoxification and recovery from alcohol addiction, smoking, tobacco, and other chemical dependencies.',
    label: 'Rehabilitation',
    image: 'https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?q=80&w=600&auto=format&fit=crop'
  },
  {
    color: '#120F17',
    title: 'Dr. Saurabh Kumar Shukla (BHMS, PGDY)',
    description: 'Experienced Consultant Physician at Punjabi Hospital. Registered Homeopathic Practitioner (Reg No: HO38824) specializing in complex cases and yoga therapy.',
    label: 'Lead Physician'
  },
  {
    color: '#120F17',
    title: 'Emergency Helpline (आपातकालीन सेवा)',
    description: 'Contact 7398956998 or WhatsApp for remote consultation, telemedicine appointments, emergency homeopathic assistance, and digital prescriptions.',
    label: '24/7 Helpline'
  }
];
      ...
      case 0: // Dermatology
        return (
          <div className="tags-container">
            ...
            <a href="#treatments" className="bento-interactive-tag">Acne (मुहाँसे)</a>
            <a href="#treatments" className="bento-interactive-tag">Hair Fall</a>
      ...
      case 1: // General Medicine
        return (
          <div className="tags-container">
            ...
            <a href="#treatments" className="bento-interactive-tag">Stones (पथरी)</a>
            <a href="#treatments" className="bento-interactive-tag">Piles (बवासीर)</a>
      ...
      case 4: // Lead Physician
        return (
          <div className="d-flex flex-wrap align-items-center gap-2 mt-2 w-100">
            ...
            <a href="#doctors" className="bento-cta-link m-0">
        ...
        return (
          <div className="d-flex flex-column w-100">
            <div className="bento-button-wrapper">
              <a href="tel:7398956998" className="bento-interactive-btn primary w-100">Call Now</a>
              <a href="https://wa.me/917398956998" target="_blank" className="bento-interactive-btn outline w-100">WhatsApp</a>
            </div>
          </div>
        );
      default:
            ...
            <div className="magic-bento-card-vertical-wrapper w-100 h-100 d-flex flex-column">
              ...
              <div className="magic-bento-card-text-holder d-flex flex-column justify-content-between flex-grow-1">
                ...
                <div className="magic-bento-card__content">
                  <h2 className="magic-bento-card__title" style={{ fontSize: '18px' }}>{card.title}</h2>
                  <p className="magic-bento-card__description" style={{ marginBottom: '8px' }}>{card.description}</p>
                  {renderInteractiveFooter(index, card)}
                </div>
              </div>
            </div>
          ) : (
